...
\begin{thebibliography}{9}
  \bibitem{eurosys2027} \textbf{NOVA: A New Framework For Remote Memory Access}\\
    ...
    EuroSys, 2027.
  \bibitem{asplos2026} \textbf{Efficient Remote Memory Ordering for Non-Coherent Interconnects}\\
    Wei Siew Liew$^*$, \underline{Md Ashfaqur Rahaman$^*$}, Adarsh Patil, Ryan Stutsman, and Vijay Nagarajan.\\
    ASPLOS, 2026. \url{https://users.cs.utah.edu/~vijay/papers/asplos26.pdf}\\
...
\\\textbf{Skills:} CUDA, PyTorch, NVLink, NCCL}
...
\cvline{2026}{Web Chair, HotNets'26}
